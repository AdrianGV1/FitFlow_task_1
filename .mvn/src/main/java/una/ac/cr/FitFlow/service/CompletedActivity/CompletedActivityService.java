...
public interface CompletedActivityService {
    CompletedActivityOutputDTO createCompletedActivity(CompletedActivityInputDTO completedActivityDTO);

    CompletedActivityOutputDTO updateCompletedActivity(Long id, CompletedActivityInputDTO completedActivityDTO);
